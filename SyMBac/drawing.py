...
def draw_scene(cell_properties, do_transformation, space_size, offset, label_masks, pinching=True):
    ...
    for properties in cell_properties:
        ...
        # print("full space shape",space.shape)
        # print(f"y: {y}, x: {x}")
        # print(f"cell_y: {cell_y}, cell_x: {cell_x}")
        ...
        # print(f"offset_y: {offset_y}, offset_x: {offset_x}")
        ...
        # print("rotated opl shape: ",rotated_OPL_cell.shape)
        # print("space shape: ", space[
