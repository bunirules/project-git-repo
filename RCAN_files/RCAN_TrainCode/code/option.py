...
parser.add_argument('--sr_dir_src', type=str,default=".",
                    help='directory for images to be super-resolved')
parser.add_argument('--sr_dir_hr', type=str,default=".",
                    help='corresponding directory for hr images')
parser.add_argument('--sr_dir_dst', type=str,default=".",
                    help='directory for super-resolved images to be placed')
